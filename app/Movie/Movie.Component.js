...
var MovieComponent = (function () {
    function MovieComponent(_movieService) {
        ...
        this.movies = { "title": "tets" };
    }
    MovieComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._movieService.getMoviedata(284052).subscribe(function (movie) { return _this.movies = movie; }, function (error) { return _this.errorMessage = error; });
